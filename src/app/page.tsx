...
import { ArrowRight, Bookmark, MessageSquare, Users } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    title: "북마크 기능",
    description:
      "중요한 면접 질문을 북마크하여 언제든지 다시 확인할 수 있습니다.",
  },
  {
    icon: Users,
    title: "그룹 관리",
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground/80 mb-12">
              실제 면접 질문을 수집하고 관리하여 취업 준비를 효율적으로
              도와드립니다
            </p>
