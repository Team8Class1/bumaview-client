...
import { answerAPI, type AnswerCreateRequest, type AnswerReplyRequest, type AnswerUpdateRequest } from '@/lib/api'
...
export const useUpdateAnswer = () => {
  ...
  return useMutation({
    mutationFn: ({ answerId, data }: { answerId: string; data: AnswerUpdateRequest }) =>
